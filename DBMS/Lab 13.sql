...
SELECT Village.Name FROM City JOIN Village
...
SELECT City.Name FROM City JOIN Village
ON City.CityID=Village.CityID
GROUP BY City.Name
...
SELECT City.Name FROM City FULL OUTER JOIN Village
ON City.CityID=Village.CityID
GROUP BY City.Name
...
SELECT COUNT(City.Name) FROM City FULL OUTER JOIN Village
ON City.CityID=Village.CityID
GROUP BY City.Name
HAVING COUNT(Village.CityID)>1;

SELECT COUNT(City.Name) From
City FULL OUTER JOIN Village
ON City.CityID=Village.CityID
Where COUNT(City.Name) =(SELECT City.Name FROM City JOIN Village
ON City.CityID=Village.CityID
GROUP BY City.Name
HAVING COUNT(Village.CityID)>1);